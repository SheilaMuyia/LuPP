...
public class PdfAdapter extends ArrayAdapter<Pdf>
{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(row==null)
        {
            ...
            holder.Unitcode =(TextView) row.findViewById(R.id.unitcode);
            holder.Lecturer =(TextView) row.findViewById(R.id.lecturer);
            row.setTag(holder);
        }
        else
        {
        ...
        holder.Year.setText(pdf.getYear());
        holder.Unitname.setText(pdf.getUnitname());
        holder.Unitcode.setText(pdf.getUnitcode());
        holder.Lecturer.setText(pdf.getLecturer());
        return row;
    }
    ...
    class PdfHolder
    {
        TextView textViewName,textViewUrl,Year,Unitname,Unitcode,Lecturer;
    }
